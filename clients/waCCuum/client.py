...
# ------------------ You shouldn't change above but you can ---------------
    ...
    if target:
        for character in myteam:
        #If current character is Druid
            if character.id%3 == 1:
                if character.in_range_of(target, gameMap):
                    if character.casting is None:
                        cast = False
                        if character.abilities[13] == 0:
                            castSkill(character, target, 13)
                        elif character.abilities[3] == 0 and weakcharacter:
        ...
        #If current character is Paladin
            if character.id%3 == 2:
                if character.in_range_of(target, gameMap):
                    if character.casting is None:
                        cast = False
                        if isStunned(target) == False and character.abilities[14] == 0:
        ...
        #If current character is Warrior
            if character.id%3 == 0:
                if character.in_range_of(target, gameMap):
                    if character.casting is None:
                        cast = False
                        if isStunned(target) == False and character.abilities[1] == 0:
